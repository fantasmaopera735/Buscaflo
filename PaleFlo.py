...
if __name__ == "__main__":
    st.set_page_config(page_title="PaleFlo", page_icon="🎯", layout="wide")
...
def main():
    st.title("🎯 PaleFlo - Pales por Grupos")

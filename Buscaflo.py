...
# --- FUNCIÓN 4: BÚSQUEDA DE SECUENCIA DE DÍGITOS (MEJORADA) ---
def buscar_secuencia_digitos(df_fijos, secuencia_input, tipo_digito):
    """
    Busca secuencia y devuelve el dígito siguiente + ejemplos de números completos.
    """
    try:
    ...
    # Diccionario para guardar: {digito_siguiente: {'count': 0, 'ejemplos': []}}
    datos_resultado = {}
    ...
    for i in range(len(lista_historica) - long_patron):
        ...
        if sub_lista == patron:
            ...
            numero_completo = df_fijos.iloc[i + long_patron]['Numero'] # Obtenemos el número real
            ...
            # Guardar hasta 3 ejemplos únicos de números completos
            if len(datos_resultado[siguiente_digito]['ejemplos']) < 3:
                formato_num = f"{numero_completo:02d}"
                if formato_num not in datos_resultado[siguiente_digito]['ejemplos']:
                    datos_resultado[siguiente_digito]['ejemplos'].append(formato_num)
    ...
    for digito, data in datos_resultado.items():
        rows.append({
            ...
            'Ejemplos de Números Históricos': ", ".join(data['ejemplos']),
...
def main():
    ...
    # ==========================================
    # PESTAÑA 4: SECUENCIA DE DÍGITOS (MEJORADA)
    # ==========================================
    with tab_secuencias:
        ...
        Ahora incluye **Ejemplos de Números** reales.
        """)
            ...
            if error:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "Ejemplos de Números Históricos": st.column_config.TextColumn("Ejemplos Reales", width="medium")
                    },
